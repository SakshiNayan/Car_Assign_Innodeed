...
function Pagination({showperPg ,total,onPaginationChange}) {
  ...
  return (
    <div className='pagination'>
        <div onClick={() => onButtonClick("prev")} className='arrow'>
            <svg  className="sign" width="15" height="20" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div  onClick={() => onButtonClick("next")} className='arrow'>
                <svg className="sign" width="15" height="20" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
